...
#if defined(__BIG_ENDIAN) && defined(CAAM_DIFF_ENDIAN) || \
    defined(__LITTLE_ENDIAN) && !defined(CAAM_DIFF_ENDIAN)
	#define rd_en_val16(value) le16_to_cpu(value)
	#define wr_en_val16(value) cpu_to_le16(value)
...
#else
	#define rd_en_val16(value) be16_to_cpu(value)
	#define wr_en_val16(value) cpu_to_be16(value)
